...
def send_txn(sender, quantity, receiver, note, sk):  # sk
...
def create_asset(
    creator, asset_name, unit_name, total, decimals, default_frozen, url, sk
):
...
# send_txn("K3MGOT5W4EO66ZSEGIFRTESQ72VAZ7FCMF6YLO2Q7O2WFLLJBGNXLAVFBY", 1000,"YTZEUGR6G4FQSIQUFYSZTPHOBYIXSZJUDAZK3KU7LMRONOCADOAT34RC6E", "hello", "K3MGOT5W4EO66ZSEGIFRTESQ72VAZ7FCMF6YLO2Q7O2WFLLJBGNXLAVFBY")
